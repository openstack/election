...
during the 2027.1 cycle, continuing in my role that started in
the 2024.1 cycle.
...
* Reduce the bug backlog. Over the past cycle we were able to reduce
  our bug backlog through the continued great work of a lot of
  contributors. Continuing this reduction, either through verification
